...
def sugerir():
    ...
    # Ranking ponderado del centroide (más bajo stock y más alto riesgo y repeticiones)
    centroides['critico'] = (centroides['riesgo'] * 0.4) + (1 / (centroides['stock'] + 1) * 0.4) + (centroides['repeticiones'] * 0.2)
